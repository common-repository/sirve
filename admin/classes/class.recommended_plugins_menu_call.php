...
class Recommended_Plugins_call {
    ...
    public function plugin_recommendations(){ 
        $get_instance = Recommended_Plugins::instance( 
            array( 
                'text_domain'       => 'sirve', 
                'parent_menu_slug'  => 'edit.php?post_type=sirve', 
                'menu_capability'   => 'manage_options', 
                'menu_page_slug'    => 'sirve-recommendations',
                'priority'          => 222,
                'assets_url'        => SIRVE_PL_URL.'admin/assets',
                'hook_suffix'       => 'sirve_page_sirve-recommendations'
            )
        );
