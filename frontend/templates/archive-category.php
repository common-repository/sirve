...
<div class="sirve_category_archive_page <?php echo esc_attr( (get_option('sirve_archive_page_style', 'style-1') == 'style-4') ? 'sirve__container--xl' : 'sirve__container');?>  sirve_options" <?php if(isset($attributes)){ echo esc_attr( "data-sirveoptions=" ). json_encode(  $attributes );}?>>
                ...
                <div class="sirve__col-lg-12">
                    ...
                    <div class="sirve__category-header">
                        <div class="sirve-category-header-title">
                            <?php
                                echo "<h1 class='sirve-category-title'>" . esc_html( get_option('sirve_fontend_category_lable','Category'). " ". $sirve_queried_object->name ) . "</h1>";
                            ?>
                        </div>
                        ...
                        <div class="sirve-ajax-search sirve__row ">
                            ...
                            <?php 
                                ...
                                if(!($query->post_count == 0)):
                                    sirve_pagination($query, $currentPage, $sirve_queried_object->slug );
                                else:
